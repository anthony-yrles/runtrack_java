...
public class Facture {
    public static void main(String[] args) {
        ...
        double taxe = 0.20; // Declare a double and assign the value 0.20 to it
        double tarifTTC = tarifHT + tarifHT * taxe; // Declare a double and assign the value of tarifHT + tarifHT * taxe to it
